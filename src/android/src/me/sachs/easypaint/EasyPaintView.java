...
public class EasyPaintView extends GLSurfaceView {
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
    	...
    	private EasyPaintView view;
    	
    	public Renderer (Context context, EasyPaintView view) {
        ...
        public void onDrawFrame(GL10 gl) {
        	...
        	if (this.view.istouched) {
        		EasyPaintLib.app_input_manager_touch_down(1, view.x, view.y);
        	} else {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
        	if (DEBUG) {
            	Log.d(TAG, "invoke native app_on_resize(" + width + ", " + height + ")");
            }
            EasyPaintLib.app_on_resize(width, height);
        }
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            if (DEBUG) {
            	Log.d(TAG, "invoke native app_init_render_context()");
            }
    		EasyPaintLib.app_init_render_context();
        }
    }
}
